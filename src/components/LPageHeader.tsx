            ...
            <NavigationMenuList>
                    ...
                    <div>
                      <div className="cursor-pointer hover:bg-gray-100 w-fit rounded-md px-2 py-1.5">
                        ...
                        <p className="text-sm max-w-[300px] text-muted-foreground">
                          Publish your book sell across 170 countries
                          seamlessly.
                        </p>
                      </div>
                      <div className="cursor-pointer hover:bg-gray-100 w-fit rounded-md px-2 py-1.5 ">
                        ...
                        <p className="text-sm max-w-[300px] text-muted-foreground">
                          Edit your books in here itself for FREE
                        </p>
                      </div>
                      <div className="cursor-pointer hover:bg-gray-100 w-fit rounded-md px-2 py-1.5">
                        <p className="font-medium text-rose-600 ">
                    ...
                    <div>
                      <div className="cursor-pointer hover:bg-gray-100 w-fit rounded-md px-2 py-1.5">
                        <p className="font-medium text-rose-600 flex items-center">
                          Be Verified{" "}
                          <VscVerifiedFilled className="size-5 ml-1 text-blue-500" />
                        </p>
                        <p className="text-sm max-w-[300px] text-muted-foreground">
                          Make yourself Trustworthy to your retailers by being
                          Verified
                        </p>
                      </div>
              ...
              <NavigationMenuItem>
                ...
                <NavigationMenuContent className="p-2">
                  <p className="ml-2  font-medium text-rose-600">Categories</p>
                  <div className="h-auto w-[580px] flex  p-2 ">
                    <div className=" px-2 flex flex-col gap-y-1.5 text-sm  text-gray-700 ">
                      <p className="flex items-center gap-1 cursor-pointer hover:text-gray-600">
                        <FaBook className="mt-1" />
                        Books
                      </p>
                      <p className="flex items-center gap-1 cursor-pointer hover:text-gray-600">
                        <RiQuillPenFill className="mt-1" />
                        Novels
                      </p>
                      <p className="flex items-center gap-1 cursor-pointer hover:text-gray-600">
                        <HiMiniDocumentText className="mt-1" />
                        Publications
                      </p>
                      <p className="flex items-center gap-1 cursor-pointer hover:text-gray-600">
                        <FaTabletScreenButton className="mt-1" />
                        eBooks
                      </p>
                      <p className="flex items-center gap-1 cursor-pointer hover:text-gray-600">
                        <GrArticle className="mt-1" />
                        Articles
                      </p>
                    </div>
